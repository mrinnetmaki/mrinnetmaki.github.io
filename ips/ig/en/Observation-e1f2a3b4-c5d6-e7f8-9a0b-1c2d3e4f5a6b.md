# Observation-lab-e-mcv-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-e-mcv-1**

## Example Observation: Observation-lab-e-mcv-1
...
**code**: Keskimääräinen punasolun tilavuus
...
**value**: 91 fl (Details: UCUM codefL = 'fL')
...
```json
{
  ...
  "code" : {
    ...
    "text" : "Keskimääräinen punasolun tilavuus"
  },
  "subject" : {
