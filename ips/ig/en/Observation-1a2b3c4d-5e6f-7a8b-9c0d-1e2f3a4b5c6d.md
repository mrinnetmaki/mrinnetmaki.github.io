# Observation-lab-e-rdw-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-e-rdw-1**

## Example Observation: Observation-lab-e-rdw-1
...
**code**: E -RDW, punasolujen kokojakauma
...
```json
{
  ...
  "code" : {
    ...
    "text" : "E -RDW, punasolujen kokojakauma"
  },
  "subject" : {
