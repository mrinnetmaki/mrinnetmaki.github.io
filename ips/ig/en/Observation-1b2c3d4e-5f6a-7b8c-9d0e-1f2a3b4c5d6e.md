# Observation-lab-p-ps-agv-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-p-ps-agv-1**

## Example Observation: Observation-lab-p-ps-agv-1
...
**code**: P -PS-AgV, proteiini S, antigeeni, vapaa
...
```json
{
  ...
  "code" : {
    "coding" : [{
      ...
      "code" : "27821-8",
      "display" : "Protein S Free Ag actual/normal in Platelet poor plasma by Immunoassay"
    },
    {
    ...
    "text" : "P -PS-AgV, proteiini S, antigeeni, vapaa"
  },
  "subject" : {
