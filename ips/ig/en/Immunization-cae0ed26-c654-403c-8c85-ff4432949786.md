# ImmunizationInfluenza1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ImmunizationInfluenza1**

## Example Immunization: ImmunizationInfluenza1
...
```json
{
  ...
  "id" : "cae0ed26-c654-403c-8c85-ff4432949786",
  "meta" : {
