# Observation-lab-p-kardabm-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-p-kardabm-1**

## Example Observation: Observation-lab-p-kardabm-1
...
**code**: P -KardAbM, kardiolipiini, IgM-vasta-aineet
...
**value**: 3 U/ml (Details: UCUM codeU/mL = 'U/mL')
...
```json
{
  ...
  "code" : {
    "coding" : [{
      ...
      "code" : "8067-1",
      "display" : "Cardiolipin IgM Ab [Units/volume] in Serum or Plasma"
    },
    {
    ...
    "text" : "P -KardAbM, kardiolipiini, IgM-vasta-aineet"
  },
  "subject" : {
