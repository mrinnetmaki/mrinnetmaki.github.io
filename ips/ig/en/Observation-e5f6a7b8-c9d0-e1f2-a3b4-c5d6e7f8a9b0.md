# Observation-lab-p-pc-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-p-pc-1**

## Example Observation: Observation-lab-p-pc-1
...
```json
{
  ...
  "code" : {
    "coding" : [{
      ...
      "code" : "27818-4",
      "display" : "Protein C actual/normal in Platelet poor plasma by Chromogenic method"
    },
    {
