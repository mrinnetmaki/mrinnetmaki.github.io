# Resource Sensotrend's International Patient Summary Implementation
...
```json
{
  ...
  "id" : "com.sensotrend.ips",
  "language" : "en",
  "url" : "https://ips.sensotrend.com/ig/ImplementationGuide/com.sensotrend.ips",
  "version" : "0.3.0",
  "name" : "SensotrendIPS",
  "title" : "Sensotrend's International Patient Summary Implementation",
  "status" : "active",
  "date" : "2026-05-15T21:22:49+03:00",
  "publisher" : "Sensotrend Oy",
  "contact" : [{
    "name" : "Sensotrend Oy",
    "telecom" : [{
      "system" : "url",
      "value" : "https://ips.sensotrend.com/"
    },
    {
      "system" : "email",
      "value" : "info@sensotrend.com"
    }]
  }],
  "description" : "This document describes Sensotrend's implementation of the [HL7 FHIR IPS](https://hl7.org/fhir/uv/ips/) format of the [International Patient Summary (IPS)](https://international-patient-summary.net/) specification both as a client app and as a FHIR server. It also includes and extensive example patient summary for Mikko, an example patient.",
  "packageId" : "com.sensotrend.ips",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://ips.sensotrend.com/ig/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      "description" : "International Patient Summary for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "name" : "IpsBundle",
      "description" : "International Patient Summary for Mikko as a FHIR Bundle",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
    ...
    },
    {
      ...
      "name" : "Mikko",
      "description" : "Mikko Virtanen, the patient",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of alcohol use for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of B -EryBla (erytroblastit) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of B -Erytrosyytit for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of F -Calpro (kalprotektiini) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of B -Hb (hemoglobiini) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of B -HbA1c (hemoglobiini-A1c) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of B -HKR (hematokriitti) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of B -Leuk (leukosyytit eli valkosolut) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of B -Trom (verihiutaleet) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of E -MCH (hemoglobiini, keskimassa) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of E -MCV (keskimääräinen punasolun tilavuus) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of E -RDW (punasolujen kokojakauma) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of fP-Fe (rauta) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of fP-Transf (transferriini) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -AT3 (antitrombiini III) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -B2GPAbG (beeta-2-glykoproteiini, IgG-vasta-aineet) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -B2GPAbM (beeta-2-glykoproteiini, IgM-vasta-aineet) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -Ferrit (ferritiini) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -K (kalium) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -KardAbG (kardiolipiini, IgG-vasta-aineet) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -KardAbM (kardiolipiini, IgM-vasta-aineet) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -Kol (kokonaiskolesteroli) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -Kol-HDL (HDL-kolesteroli) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -Kol-LDL (LDL-kolesteroli) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -Krea (kreatiniini) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -LuakPTT (lupusantikoagulantti, PTT) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -LuakRVV (lupusantikoagulantti, dRVVT) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -Na (natrium) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -PC (proteiini C) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -PS-AgV (proteiini S, antigeeni, vapaa) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -TrAika (trombiiniaika) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -Trigly (triglyseridi) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -TT-INR (tromboplastiiniaika, INR-tulostus) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of P -TT-SPA (tromboplastiiniaika, SPA-tulostus) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of Pt-GFReEPI (glomerulussuodosnopeus, estimoitu) 1 for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of Pt-GFReEPI (glomerulussuodosnopeus, estimoitu) 2 for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of TrFeSat (transferriinin rautakyllästeisyys) for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of U -Alb (albumiini) 1 for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of U -Alb (albumiini) 2 for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of U -Alb/Kre (albumiini-kreatiniinisuhde) 1 for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of U -Alb/Kre (albumiini-kreatiniinisuhde) 2 for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of U -Krea (kreatiniini) 1 for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of U -Krea (kreatiniini) 2 for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of tobacco use for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of blood pressure 1 for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of blood pressure 2 for Mikko",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of blood pressure 3 for Mikko, performed at a clinic",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Observation of blood pressure 4 for Mikko, performed at a clinic",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
