# Observation-lab-trfesat-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-trfesat-1**

## Example Observation: Observation-lab-trfesat-1
...
**code**: -TrFeSat, transferriinin rautakyllästeisyys
...
```json
{
  ...
  "code" : {
    ...
    "text" : "-TrFeSat, transferriinin rautakyllästeisyys"
  },
  "subject" : {
