# ImmunizationCovid1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ImmunizationCovid1**

## Example Immunization: ImmunizationCovid1
...
```json
{
  ...
  "id" : "d9828658-c9dd-478c-8573-c514cd834f5f",
  "meta" : {
