# Sensotrend IPS Server Capability Statement - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Sensotrend IPS Server Capability Statement**

## CapabilityStatement: Sensotrend IPS Server Capability Statement 
...
```json
{
  ...
  "id" : "ips-server-capability-statement",
  "url" : "https://ips.sensotrend.com/ig/CapabilityStatement/ips-server-capability-statement",
  "version" : "0.4.0",
  "name" : "SensotrendIpsServerCapabilityStatement",
  "title" : "Sensotrend's IPS Server Capability Statement",
  "status" : "active",
  "date" : "2026-03-12",
  ...
  "purpose" : "The metadata about Sensotrend's IPS Server implementation, including the supported resources and operations.",
  "kind" : "instance",
  "instantiates" : ["http://hl7.org/fhir/uv/ips/CapabilityStatement/ips-server|2.0.0"],
  "software" : {
    "name" : "Sensotrend IPS Server",
    "version" : "0.1.0",
    "releaseDate" : "2026-03-12"
  },
  "implementation" : {
    "description" : "Sensotrend's IPS Server implementation",
    "url" : "https://ips.sensotrend.com/fhir/metadata"
  },
  "fhirVersion" : "4.0.1",
  "format" : ["json"],
