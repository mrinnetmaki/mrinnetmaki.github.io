# Observation-lab-b-leuk-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-b-leuk-1**

## Example Observation: Observation-lab-b-leuk-1
...
```json
{
  ...
  "code" : {
    ...
    "text" : "B -Leuk, leukosyytit eli valkosolut"
  },
  "subject" : {
