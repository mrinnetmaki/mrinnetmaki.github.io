# ImmunizationInfluenza3 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ImmunizationInfluenza3**

## Example Immunization: ImmunizationInfluenza3
...
```json
{
  ...
  "id" : "04dfd1be-9483-485d-8030-a9ce3a264363",
  "meta" : {
