# Observation-lab-u-krea-2 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-u-krea-2**

## Example Observation: Observation-lab-u-krea-2
...
**value**: 12.4 mg/dl (Details: UCUM codemg/dl = 'mg/dl')
...
```json
{
  ...
  "id" : "26868547-dc76-45a1-9f6e-3ce6fe2d4e61",
  "meta" : {
