# Observation-lab-p-b2gpabg-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-p-b2gpabg-1**

## Example Observation: Observation-lab-p-b2gpabg-1
...
**code**: P -B2GPAbG, beeta-2-glykoproteiini, IgG-vasta-aineet
...
**value**: 4 U/ml (Details: UCUM codeU/mL = 'U/mL')
...
```json
{
  ...
  "code" : {
    "coding" : [{
      ...
      "code" : "44448-9",
      "display" : "Beta 2 glycoprotein 1 IgG Ab [Units/volume] in Serum or Plasma by Immunoassay"
    },
    {
    ...
    "text" : "P -B2GPAbG, beeta-2-glykoproteiini, IgG-vasta-aineet"
  },
  "subject" : {
