# ImmunizationCovid4 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ImmunizationCovid4**

## Example Immunization: ImmunizationCovid4
...
```json
{
  ...
  "id" : "9c0744c0-9b0a-4796-b653-452a0098625f",
  "meta" : {
