# ConditionVocalChord-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ConditionVocalChord-1**

## Example Condition: ConditionVocalChord-1
...
```json
{
  ...
  "id" : "d621ec37-44d1-455a-9f95-b62ee1e6f7f1",
  "meta" : {
  ...
  "code" : {
    ...
    "text" : "Dysphonia due to vocal cord problems"
  },
  "subject" : {
    "reference" : "urn:uuid:b4ac89c5-6589-417f-beef-d3fb1ef9c70f",
    "display" : "Mikael Rinnetmäki"
  },
  "onsetDateTime" : "2016-05-06",
  "asserter" : {
    "display" : "Sipilä, Markku"
  }
}
