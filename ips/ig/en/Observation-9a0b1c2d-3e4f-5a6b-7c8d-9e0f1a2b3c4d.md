# Observation-lab-p-traika-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-p-traika-1**

## Example Observation: Observation-lab-p-traika-1
...
**value**: 21 s (Details: UCUM codes = 's')
