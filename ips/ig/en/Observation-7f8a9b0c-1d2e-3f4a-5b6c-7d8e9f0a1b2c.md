# Observation-lab-p-tt-inr-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-p-tt-inr-1**

## Example Observation: Observation-lab-p-tt-inr-1
...
**code**: P -TT-INR, tromboplastiiniaika, INR-tulostus
...
**value**: 1.1 inr (Details: UCUM code1 = '1')
...
```json
{
  ...
  "code" : {
    ...
    "text" : "P -TT-INR, tromboplastiiniaika, INR-tulostus"
  },
  "subject" : {
