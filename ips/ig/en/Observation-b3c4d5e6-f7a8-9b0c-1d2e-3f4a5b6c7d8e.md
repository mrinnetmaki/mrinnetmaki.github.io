# Observation-lab-p-trigly-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-p-trigly-1**

## Example Observation: Observation-lab-p-trigly-1
...
**value**: 0.88 mmol/l (Details: UCUM codemmol/L = 'mmol/L')
