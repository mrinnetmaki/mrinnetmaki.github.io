# Observation-vitals-bloodpressure-2 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-vitals-bloodpressure-2**

## Example Observation: Observation-vitals-bloodpressure-2
...
> **component****code**: Systolic blood pressure**value**: 150 mmHg (Details: UCUM codemm[Hg] = 'mm[Hg]')

> **component****code**: Diastolic blood pressure**value**: 76 mmHg (Details: UCUM codemm[Hg] = 'mm[Hg]')
