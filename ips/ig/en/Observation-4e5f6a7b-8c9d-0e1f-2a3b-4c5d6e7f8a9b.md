# Observation-lab-p-luakptt-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-p-luakptt-1**

## Example Observation: Observation-lab-p-luakptt-1
...
**code**: P -LuakPTT, lupusantikoagulantti, PTT
...
**value**: 1.04 suhde (Details: UCUM code1 = '1')
...
```json
{
  ...
  "code" : {
    ...
    "text" : "P -LuakPTT, lupusantikoagulantti, PTT"
  },
  "subject" : {
