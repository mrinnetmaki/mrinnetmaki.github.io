# Observation-lab-p-kol-1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-lab-p-kol-1**

## Example Observation: Observation-lab-p-kol-1
