# ImmunizationInfluenza4 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ImmunizationInfluenza4**

## Example Immunization: ImmunizationInfluenza4
...
```json
{
  ...
  "id" : "5906618a-e76b-44b5-b670-7a0820075bae",
  "meta" : {
