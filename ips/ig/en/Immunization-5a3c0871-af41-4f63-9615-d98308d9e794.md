# ImmunizationTetanus1 - International Patient Summary for Mikael Rinnetmäki v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ImmunizationTetanus1**

## Example Immunization: ImmunizationTetanus1
...
```json
{
  ...
  "id" : "5a3c0871-af41-4f63-9615-d98308d9e794",
  "meta" : {
